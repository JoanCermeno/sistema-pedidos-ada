  ...
  return (
    <div className="flex-1 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 ">
        ...
        <div className="card shadow-lg bg-orange-50 text-secondary-content hover:cursor-pointer hover:shadow-2xl  hover:scale-105 transition ease-out" onClick={ () => navigate("/precios")}>
        ...
        <div className="card shadow-lg bg-orange-50 text-accent-content hover:cursor-pointer hover:shadow-2xl hover:scale-105 transition ease-out" onClick={ () => navigate("/ventas")}>
          <div className="card-body ">
        ...
        <div className="card shadow-lg bg-orange-50 text-accent-content hover:cursor-pointer hover:shadow-2xl hover:scale-105 transition ease-out" onClick={ () => navigate("/facturar")}>
          <div className="card-body ">
            <h2 className="card-title text-orange-800 font-bold">Facturar</h2>
            <p className="text-orange-950">Realizar una venta de productos.</p> 
          </div>
        </div>
      </div>
    </div>
